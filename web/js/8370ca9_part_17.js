...
angular.module('publiPrApp').directive('ngC3', ngC3);
...
angular.module('publiPrApp').directive('chosen', chosen);
...
angular.module('publiPrApp').directive('sideNavigation', sideNavigation);
...
angular.module('publiPrApp').directive('offscreen', offscreen);
...
angular.module('publiPrApp').directive('panelControlCollapse', panelControlCollapse);
...
angular.module('publiPrApp').directive('panelControlRefresh', panelControlRefresh);
...
angular.module('publiPrApp').directive('panelControlRemove', panelControlRemove);
...
angular.module('publiPrApp').directive('preloader', preloader);
...
angular.module('publiPrApp').directive('quickLaunch', quickLaunch);
...
angular.module('publiPrApp').directive('rickshaw', rickshaw);
...
angular.module('publiPrApp').directive('scrollUp', scrollUp);
...
angular.module('publiPrApp').directive('vector', vector);
