...
/**
 * User Payment Plan REST Controller
 * 
 ...
 * @see      UserPaymentPlanRESTController
 * @since      Class available since Release 1.0
 * @access    public
 * @RouteResource("UserPaymentPlan")
 */
class UserPaymentPlanRESTController extends BaseRESTController
{
    /**
     * Get a User Payment Plan entity
     *
     ...
     *
     */
    public function getAction(UserPaymentPlan $entity)
    {
    ...
    /**
     * Get all User Payment Plan entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $qbList = clone $qb;
            $qb->select('count(upp_.id)');
            $data['inlineCount'] = $qb->getQuery()->getSingleScalarResult();
            foreach ($order_by as $field => $direction) {
                $field = str_replace('userPaymentPlan.', 'upp_.', $field);
                $qbList->addOrderBy($field, $direction);
            }
            $qbList->select('upp_');
            $qbList->setMaxResults($limit);
            $qbList->setFirstResult($offset);
            $qbList->groupBy('upp_.id');
    ...
    /**
     * Create a User Payment Plan entity.
     *
    ...
    /**
     * Update a User Payment Plan entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function putAction(Request $request, UserPaymentPlan $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a User Payment Plan entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, UserPaymentPlan $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a User Payment Plan entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, UserPaymentPlan $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
