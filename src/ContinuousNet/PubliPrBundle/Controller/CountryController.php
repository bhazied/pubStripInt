...
use ContinuousNet\PubliPrBundle\Entity\Country;
use ContinuousNet\PubliPrBundle\Form\CountryType;
...
class CountryController extends BaseController
{
	...
	public function indexAction()
	{
		...
		$countries = $em->getRepository('PubliPrBundle:Country')->findAll();

		return $this->render('PubliPrBundle:Country:index.html.twig', array(
			'countries' => $countries,
		));
	}
	...
	{
		$country = new Country();
		$form = $this->createForm('ContinuousNet\PubliPrBundle\Form\CountryType', $country);
		...
		return $this->render('PubliPrBundle:Country:new.html.twig', array(
			'country' => $country,
	...
	public function showAction(Country $country)
	{
		...
		return $this->render('PubliPrBundle:Country:show.html.twig', array(
			'country' => $country,
	...
	{
		$deleteForm = $this->createDeleteForm($country);
		$editForm = $this->createForm('ContinuousNet\PubliPrBundle\Form\CountryType', $country);
		...
		return $this->render('PubliPrBundle:Country:edit.html.twig', array(
			'country' => $country,
