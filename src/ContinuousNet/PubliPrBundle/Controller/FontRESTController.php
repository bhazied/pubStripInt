 ...
 * @RouteResource("Font")
 */
class FontRESTController extends BaseRESTController
{
    /**
     * Get a Font entity
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $textFields = array('font.name', 'font.cssName');
            foreach ($filters as $field => $value) {
                $_field = str_replace('font.', 'f_.', $field);
            ...
            foreach ($order_by as $field => $direction) {
                $field = str_replace('font.', 'f_.', $field);
    ...
    public function postAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = new Font();
        $form = $this->createForm(new FontType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Font $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Font entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Font $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Font entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Font $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
