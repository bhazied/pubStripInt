 ...
 * Setting Entity
 * 
 * Storing Settings data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`setting`", indexes={@ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
