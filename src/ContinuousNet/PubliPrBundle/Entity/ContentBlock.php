 ...
 * 
 * Storing ContentBlocks data to the database using Doctrine
 * 
 * PHP version 5.4.4
 * 
 ...
 * @access     public
 * 
 * @ORM\Table(name="`content_block`", indexes={@ORM\Index(name="creator_user_id", columns={"creator_user_id"}), @ORM\Index(name="modifier_user_id", columns={"modifier_user_id"})})
 * @ORM\Entity
...
class ContentBlock 
{
     ...
     * @access private
     *
     * @ORM\Column(name="block_type", type="string", nullable=false, unique=false)
     * 
     * @Expose
     * 
     */
