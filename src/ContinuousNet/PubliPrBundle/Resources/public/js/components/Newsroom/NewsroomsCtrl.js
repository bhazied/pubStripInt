...
function($scope, $rootScope, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $fontsDataFactory, $usersDataFactory, $newsroomsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'viadeo_link', title: $filter('translate')('content.list.fields.VIADEOLINK'), sortable: 'newsroom.viadeoLink', filter: { 'newsroom.viadeoLink': 'text' }, show: $scope.getParamValue('viadeo_link_show_filed', false), getValue: $scope.textValue },
