...
function($scope, $rootScope, $sce, $timeout, $filter, ngTableParams, $state, $q, $interpolate, $localStorage, toaster, SweetAlert, $fontsDataFactory, $usersDataFactory, $newsroomsDataFactory) {
    ...
    $scope.setCols = function() {
        $scope.cols = [
            ...
            { field: 'piwik_reference', title: $filter('translate')('content.list.fields.PIWIKREFERENCE'), sortable: 'newsroom.piwikReference', filter: { 'newsroom.piwikReference': 'number' }, show: $scope.getParamValue('piwik_reference_show_filed', false), getValue: $scope.textValue },
            ...
            { field: 'created_at', title: $filter('translate')('content.list.fields.CREATEDAT'), sortable: 'newsroom.createdAt', filter: { 'newsroom.createdAt': 'number' }, show: $scope.getParamValue('created_at_show_filed', false), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
            ...
            { field: 'modified_at', title: $filter('translate')('content.list.fields.MODIFIEDAT'), sortable: 'newsroom.modifiedAt', filter: { 'newsroom.modifiedAt': 'number' }, show: $scope.getParamValue('modified_at_show_filed', false), getValue: $scope.evaluatedValue, valueFormatter: 'date:\''+$filter('translate')('formats.DATETIME')+'\''},
